            ...
            <ul className="space-y-4">
              {records.map((rec, idx) => (
                <li key={idx} className="flex flex-col md:flex-row md:justify-between md:items-center border-b border-rose-200 pb-2 last:border-b-0">
                  <span className="font-semibold text-gray-700">Malaria: <span className="text-red-900">{rec.malaria || "N/A"}</span></span>
                  <span className="font-semibold text-gray-700">Genotype: <span className="text-red-900">{rec.genotype || "N/A"}</span></span>
